...
const bestteachAbout = `＜単発からの新しい家庭教師サービス「ベストティーチ」＞
...
${companyInfo}`,
  ...
  },
  {
    ...
    date: '2025.06.01',
    category: 'プレスリリース',
    content: `「ベストティーチ」はLINE上で授業予約からフィードバックまでが完結するWebアプリ版の提供を開始しました。授業のマッチング、先生・運営とのやりとり、予約履歴の確認など、すべてをLINE内で管理することができます。
...
export const newsFilterOptions: NewsFilterOptions = {
  ...
  themes: ['FastPass', 'AIチャレンジャーズフェス', 'FastPass meetup', 'ベストティーチ', 'その他'],
